...
assert_contains "/boom.php?id=I3" 'id="famtree"' "Tree view chart container renders"
assert_contains "/boom.php?id=I3" "js/familytree.js" "Tree view loads chart script"
